import type { DesignDocumentAppliesTo, DesignDocumentCard } from "@cx/types/ai-deck";
import type { DesignDocumentId } from "@cx/types/composition-output";

/**
 * 디자인 마크다운 문서를 `DesignDocumentCard`로 압축하는 파서.
 * deck builder와 validator의 SSOT 직조회가 공유한다.
 */
...
export function parseDesignDocument(id: DesignDocumentId, content: string): DesignDocumentCard {
