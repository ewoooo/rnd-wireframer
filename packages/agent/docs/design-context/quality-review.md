...
Source docs: `packages/agent/docs/skills/quality-review/checklist.md`, `packages/agent/docs/skills/screen-generation/checklist.md`, `packages/agent/docs/skills/references/design/SECTION_PATTERNS.md`, `packages/agent/docs/skills/references/design/INTERACTION_PATTERNS.md`
