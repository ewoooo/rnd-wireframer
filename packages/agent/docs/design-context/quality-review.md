...
Source docs: `packages/agent/docs/skills/quality-review/README.md`, `packages/agent/docs/skills/screen-generation/README.md`, `packages/agent/docs/skills/design-skills/design-fundamentals/source/SECTION_PATTERNS.md`, `packages/agent/docs/skills/design-skills/design-fundamentals/source/INTERACTION_PATTERNS.md`
