...
export function buildScreenGenerationAgentInput(
	...
	return {
		query: [
			...
			"Area metadata.title and props.name are structural metadata only, not visible copy. If a section heading should be visible, render it with an explicit heading component such as TitleSection using context.decorationPlan.areas[].displayTitle.",
