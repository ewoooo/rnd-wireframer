...
export const externalCatalog: ComponentCatalog = {
	...
	"kiki.PhoneVerificationCodeField": {
		...
		source: "kiki-draft",
		label: "[kiki/draft] PhoneVerificationCodeField",
		version: "0.0.0",
		description:
		...
		props: {
			...
			remainingSeconds: { type: "number", role: "data", required: false },
			sentNotice: { type: "string", role: "description", required: false },
			sendActionLabel: { type: "string", role: "label", required: false },
			resendActionLabel: { type: "string", role: "label", required: false },
			onChange: { type: "string", role: "event", required: false },
			onRequest: { type: "string", role: "event", required: false },
			onResend: { type: "string", role: "event", required: false },
		},
	},
	"kiki.Pin": {
		type: "kiki.Pin",
