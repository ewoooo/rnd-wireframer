...
import { AgentRegistryNavigation } from "./agent/AgentRegistryNavigation";
import { ScreenRouteCard } from "./ScreenRouteCard";
import { WorkBenchNavigationRail } from "./WorkBenchNavigationRail";
	...
	return (
		<Sidebar side="left">
			<SidebarContent className="flex-row gap-0 overflow-hidden p-0">
				<WorkBenchNavigationRail activeTab={activeTab} onSelectTab={selectTab} />
