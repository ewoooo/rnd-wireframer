...
export async function runGenerationSmoke(
	...
	if (!parseCommandResult.parseResult.ok) {
		const pipelineResult = await runSideEffects({
			...
			commands: createGenerationSmokeArtifactCommands({
				...
				outDir,
				parseCommandResult,
				patternLayerCandidates: undefined,
				patternSelectionAgentInput: undefined,
				patternSelectionAgentResult: undefined,
				patternSelectionRunnerRequest: undefined,
	...
	return {
		...
		outDir,
		parseCommandResult,
		patternLayerCandidates: generationRun.patternLayerCandidates,
		patternSelectionAgentInput: generationRun.patternSelectionAgentInput,
		patternSelectionAgentResult: generationRun.patternSelectionAgentResult,
		patternSelectionRunnerRequest: generationRun.patternSelectionRunnerRequest,
