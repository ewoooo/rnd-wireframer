---
화면 ID: NOVA-PRDD-PG-007-0
화면 명: 옵션·구성 선택
화면 설명: 고객이 색상, 용량, 요금제, 부가서비스, 프로그램, 혜택 구성을 선택한다.
화면 경로: 옵션·구성 선택
구현 유형: PG
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 정상 | 옵션·구성 선택 목록과 조합 검증 결과 기본 표시 | apiCall |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-008-0 | 가입·구매 조건 검증 | 옵션·구성 선택 결과가 성공으로 확정된 경우 | 선택 구성, 판정 근거 | - |
| 케이스 분기 | NOVA-PRDD-PG-007-1 | 옵션·구성 선택-재고·판매 상태·가입 조건 미확정 | 재고·판매 상태·가입 조건 미확정 | - | 담기 미확정 후 보완 항목 안내 후 화면 유지 |
| 케이스 분기 | NOVA-PRDD-PG-007-2 | 옵션·구성 선택-선택 조합 충돌 | 선택 조합 충돌 | - | 충돌 항목만 수정 안내 후 화면 유지 |
| 케이스 분기 | NOVA-PRDD-PG-007-3 | 옵션·구성 선택-로그인·인증 후 복귀 시 선택 구성 소실 | 로그인·인증 후 복귀 시 선택 구성 소실 | - | 선택 구성 복원 후 화면 유지 |
| 케이스 분기 | NOVA-PRDD-PG-007-4 | 옵션·구성 선택-재고·판매 상태·가입 조건 미확정 | 재고·판매 상태·가입 조건 미확정 | - | 담기 미확정 후 보완 항목 안내 후 화면 유지 |
| 케이스 분기 | NOVA-PRDD-PG-007-5 | 옵션·구성 선택-선택 조합 충돌 | 선택 조합 충돌 | - | 충돌 항목만 수정 안내 후 화면 유지 |
| 케이스 분기 | NOVA-PRDD-PG-007-6 | 옵션·구성 선택-로그인·인증 후 복귀 시 선택 구성 소실 | 로그인·인증 후 복귀 시 선택 구성 소실 | - | 선택 구성 복원 후 화면 유지 |
