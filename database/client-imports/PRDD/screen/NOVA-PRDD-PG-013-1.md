---
화면 ID: NOVA-PRDD-PG-013-1
화면 명: 담기 완료 후 다음 행동 선택-재고·판매 상태·가입 조건 미확정
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 재고·판매 상태·가입 조건 미확정 | [영역 3] 보완 필요 항목 강조 + [영역 999] CTA disabled | setState |
| TwoButton | 미확정 항목 보완 후 다음 행동 선택 가능 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-013-0 | 담기 완료 후 다음 행동 선택 | 재고·판매 상태·가입 조건 미확정 해소 후 | - | - |
