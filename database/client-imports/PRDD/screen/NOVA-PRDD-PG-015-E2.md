---
화면 ID: NOVA-PRDD-PG-015-E2
화면 명: 선택 불가·충돌 사유 안내-상담 전환 문맥 누락
...
| 999 | 1 | ActionButtonRecover | 화면 하단 복구 진행 CTA | ActionButton | default | - | - | - | main: 보완하고 상담 접수 | 원위치 복귀 정보 (api:FN-PRDD-FAIL-001) | [정책:PI-PRDD-FAIL-001-03] 인증 복귀 |

## 화면 흐름

| 구분 | 화면 ID | 화면 명 | 조건 | 전달 데이터 | 후속 처리 |
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-015-0 | 선택 불가·충돌 사유 안내 | 상담 전환 문맥 누락 해소 후 | - | - |
