---
화면 ID: NOVA-PRDD-PG-013-2
화면 명: 담기 완료 후 다음 행동 선택-선택 조합 충돌
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 선택 조합 충돌 감지 | [영역 3] 충돌 항목 강조 + 수정 안내 노출 | setState |
| TwoButton | 충돌 항목 수정 후 다음 행동 선택 가능 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-013-0 | 담기 완료 후 다음 행동 선택 | 선택 조합 충돌 해소 후 | - | - |
