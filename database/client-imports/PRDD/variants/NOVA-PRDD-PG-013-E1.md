---
화면 ID: NOVA-PRDD-PG-013-E1
화면 명: 담기 완료 후 다음 행동 선택-내부 운영 코드 노출
화면 설명: 내부 운영 코드·원장 필드명이 고객 문구로 노출되어 배포를 제한한다.
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 내부 운영 코드·원장 필드명 노출 감지 | [영역 3] 노출 항목 차단 + 배포 제한 안내 | - |
| TwoButton | 노출 항목 차단 후 다음 행동 선택 가능 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-013-0 | 담기 완료 후 다음 행동 선택 | 내부 운영 코드 노출 해소 후 | - | - |
