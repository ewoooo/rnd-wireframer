---
화면 ID: NOVA-PRDD-PG-010-E1
화면 명: 공유·딥링크·문의 맥락 유지-미디어·후기·스펙 로딩 실패
화면 설명: 미디어·후기·스펙 로딩 실패 (로딩 실패) — 핵심 요약과 가격·조건 판단은 유지한다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 미디어·후기·스펙 로딩 실패 상태 | 핵심 요약·가격·조건 판단은 유지하고 Callout 오류 안내 노출 | apiCall |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-010-0 | 공유·딥링크·문의 맥락 유지 | 미디어·후기·스펙 로딩 실패 해소 후 | - | - |
