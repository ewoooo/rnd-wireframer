---
화면 ID: NOVA-PRDD-PG-015-E4
화면 명: 선택 불가·충돌 사유 안내-재고·판매·가입 조건 미확정
화면 설명: 재고·판매·가입 조건 미확정 — 담기를 확정하지 않고 보완 가능한 항목 안내
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 정상 | [영역 1] Callout 보완 안내 + 보완 가능 항목 강조 / [영역 999] CTA disabled | - |
...
| 999 | 1 | ActionButtonRecover | 화면 하단 복구 진행 CTA | ActionButton | default | - | - | - | main: 계속하기 | 원위치 복귀 정보 (api:FN-PRDD-FAIL-001) | [정책:PI-PRDD-FAIL-001-03] 인증 복귀 |
