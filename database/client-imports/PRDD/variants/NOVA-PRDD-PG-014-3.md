---
화면 ID: NOVA-PRDD-PG-014-3
화면 명: 장바구니·주문 진입 연결-로그인·인증 후 선택 구성 소실
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 로그인·인증 후 복귀 시 선택 구성 소실 | [영역 1] 이전 선택 구성 복원 표시 | apiCall |
| TwoButton | 선택 구성 복원 후 진입 구성 확정 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-014-0 | 장바구니·주문 진입 연결 | 로그인·인증 후 선택 구성 소실 해소 후 | - | - |
