---
화면 ID: NOVA-PRDD-PU-016-E3
화면 명: 로그인·인증 후 원위치 복귀-인증 실패 후 원위치 복귀 불가
...
| 999 | 1 | ActionButtonRecover | 화면 하단 인증 진행 CTA | ActionButton | default | onClick | navigate | NOVA-PRDD-PG-015-0 | main: 다시 선택하기 | 원위치 복귀 정보 (api:FN-PRDD-AUTH-001) | [정책:PI-PRDD-FAIL-001-03] 인증 복귀 |
