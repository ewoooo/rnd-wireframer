---
화면 ID: NOVA-PRDD-PG-013-4
화면 명: 담기 완료 후 다음 행동 선택-상품 기준 정보 누락
화면 설명: 상품 기준 정보가 누락되어 해당 섹션을 숨기지 않고 보완 필요 또는 상담 가능 경로를 안내한다.
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 상품 기준 정보 누락 감지 | [영역 3] 보완 필요·상담 가능 경로 안내 노출 | - |
| TwoButton | 보완·상담 경로 확인 후 다음 행동 선택 가능 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-013-0 | 담기 완료 후 다음 행동 선택 | 상품 기준 정보 누락 해소 후 | - | - |
