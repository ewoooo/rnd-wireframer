---
화면 ID: NOVA-PRDD-PG-014-1
화면 명: 장바구니·주문 진입 연결-재고·판매 상태·가입 조건 미확정
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 재고·판매 상태·가입 조건 미확정 | [영역 2] 보완 필요 항목 강조 + [영역 999] CTA disabled | setState |
| TwoButton | 미확정 항목 보완 후 진입 구성 확정 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-014-0 | 장바구니·주문 진입 연결 | 재고·판매 상태·가입 조건 미확정 해소 후 | - | - |
