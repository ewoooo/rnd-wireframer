---
화면 ID: NOVA-PRDD-PG-013-E2
화면 명: 담기 완료 후 다음 행동 선택-미디어·후기·스펙 로딩 실패
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 미디어·후기·스펙 로딩 실패 | [영역 3] 핵심 요약 유지 + 일부 항목 미노출 | apiCall |
| TwoButton | 핵심 요약 확인 후 다음 행동 선택 가능 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-013-0 | 담기 완료 후 다음 행동 선택 | 미디어·후기·스펙 로딩 실패 해소 후 | - | - |
