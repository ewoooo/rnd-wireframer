---
화면 ID: NOVA-PRDD-PG-010-2
화면 명: 공유·딥링크·문의 맥락 유지-내부 운영 코드·원장 필드명 고객 노출
화면 설명: 내부 운영 코드·원장 필드명 고객 노출 (노출 제한) — 배포를 제한한다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 내부 운영 코드·원장 필드명 고객 노출 상태 | 배포를 제한한다 — 보완 항목 강조 + Callout 안내 노출 | setState |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-010-0 | 공유·딥링크·문의 맥락 유지 | 내부 운영 코드·원장 필드명 고객 노출 해소 후 | - | - |
