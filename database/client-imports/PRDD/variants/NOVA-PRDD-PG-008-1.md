---
화면 ID: NOVA-PRDD-PG-008-1
화면 명: 가입·구매 조건 검증-재고·판매 상태·가입 조건 미확정
화면 설명: 재고·판매 상태·가입 조건 미확정 (보완 필요) — 담기를 확정하지 않고 보완 가능한 항목을 안내한다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 재고·판매 상태·가입 조건 미확정 상태 | 담기를 확정하지 않고 보완 가능한 항목을 안내한다 — 보완 항목 강조 + Callout 안내 노출 | setState |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-008-0 | 가입·구매 조건 검증 | 재고·판매 상태·가입 조건 미확정 해소 후 | - | - |
