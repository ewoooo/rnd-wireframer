---
화면 ID: NOVA-PRDD-PG-014-E1
화면 명: 장바구니·주문 진입 연결-외부채널·Product Catalog 연동 장애
화면 설명: 외부채널·Product Catalog 연동 장애로 고객 표시를 제한하거나 보조 안내로 전환한다.
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|------|--------|---------------|------|
| default | 외부채널·Product Catalog 연동 장애 | [영역 2] 보조 안내로 전환 + 표시 제한 | apiCall |
| TwoButton | 연동 장애 보조 안내 확인 후 진입 구성 확정 | ActionButton main·secondary 슬롯 활성 | - |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-014-0 | 장바구니·주문 진입 연결 | 외부채널·Product Catalog 연동 장애 해소 후 | - | - |
