---
화면 ID: NOVA-PRDD-PG-010-3
화면 명: 공유·딥링크·문의 맥락 유지-상담 전환 시 상품 ID·옵션·오류 사유 누락
화면 설명: 상담 전환 시 상품 ID·옵션·오류 사유 누락 (보완 필요) — 상담 접수 전 보완한다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 상담 전환 시 상품 ID·옵션·오류 사유 누락 상태 | 상담 접수 전 보완한다 — 보완 항목 강조 + Callout 안내 노출 | setState |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-010-0 | 공유·딥링크·문의 맥락 유지 | 상담 전환 시 상품 ID·옵션·오류 사유 누락 해소 후 | - | - |
