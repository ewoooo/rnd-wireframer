---
화면 ID: NOVA-PRDD-PG-006-E1
화면 명: 추천·AI 요약 근거 검토-내부 운영 코드·원장 필드명 노출
...
| 1 | 2 | CalloutAiSummary | AI 요약 (내부 문구 노출 차단) | Callout | WithTitle | - | - | - | title: 일부 항목을 점검 중입니다<br>body: 내부 운영 코드·원장 필드명이 고객 문구로 노출되어 해당 항목 표시를 제한했습니다. | 미노출·대체 안내 사유 (api:FN-PRDD-AI-001)<br>고객 문구 노출 제한 기준 (policy:PI-PRDD-CATALOG-001-04) | [정책:PI-PRDD-CATALOG-001-04] 정책 수신 |
...
|------|---------|---------|------|-------------|-----------|
| 화면 전환 | NOVA-PRDD-PG-006-0 | 추천·AI 요약 근거 검토 | 내부 운영 코드·원장 필드명 노출 해소 후 | - | - |
