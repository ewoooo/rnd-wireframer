---
화면 ID: NOVA-PRDD-PG-009-E2
화면 명: 예상 비용·혜택 요약-혜택 만료·소진·중복 불가
화면 설명: 혜택 만료·소진·중복 불가 (혜택 만료) — 담기 전에 미적용 사유를 고지한다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 혜택 만료·소진·중복 불가 상태 | 담기 전에 미적용 사유를 고지한다 — 보완 항목 강조 + Callout 안내 노출 | setState |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-009-0 | 예상 비용·혜택 요약 | 혜택 만료·소진·중복 불가 해소 후 | - | - |
