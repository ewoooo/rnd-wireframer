---
화면 ID: NOVA-PRDD-PG-009-3
화면 명: 예상 비용·혜택 요약-혜택 산정 결과 원장·프로모션 기간 불일치
화면 설명: 혜택 산정 결과 원장·프로모션 기간 불일치 (보완 필요) — 예상 금액 표시를 보류하고 사유를 남긴다
...
| 상태 | 트리거 | 컴포넌트 변화 | 액션 |
|---|---|---|---|
| default | 화면 진입 시 혜택 산정 결과 원장·프로모션 기간 불일치 상태 | 예상 금액 표시를 보류하고 사유를 남긴다 — 보완 항목 강조 + Callout 안내 노출 | setState |
...
|---|---|---|---|---|---|
| 화면 전환 | NOVA-PRDD-PG-009-0 | 예상 비용·혜택 요약 | 혜택 산정 결과 원장·프로모션 기간 불일치 해소 후 | - | - |
